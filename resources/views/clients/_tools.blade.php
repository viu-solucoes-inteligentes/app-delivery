<div class="col-md-3">
    <a href="{{ route('clients.create') }}" class="btn btn-success btn-block margin-bottom btn-lg"><span
    ...
    <div class="box box-success">
        ...
        <div class="box-body no-padding">
            <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="{{ route('clients') }}"><i class="fa fa-fw fa-list-ul"></i> Clientes
                        </a></li>
