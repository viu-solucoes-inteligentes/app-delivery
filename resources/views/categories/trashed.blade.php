...
@section('body')
    <section class="content-header">
        ...
        {{ \Breadcrumbs::render('categories.trashed') }}
    </section>

    <!-- Main content -->
    <section class="content">
        <div class="row">
            @include('categories._tools_trashed')
            <div class="col-md-9">
                ...
                <div class="box box-success ">
                    ...
                    <div class="box-body">
                        {!! Form::open(['route' => 'categories.trashed.search']) !!}
                        <div class="col-md-6">
                                ...
                                @foreach($categories as $user)
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            ...
                                            <form action="{{ route('categories.trashed.update', $user->id) }}" method="POST"
